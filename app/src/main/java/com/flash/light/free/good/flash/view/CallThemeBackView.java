package com.flash.light.free.good.flash.view;
...
import com.flash.light.free.good.flash.util.ResourceUtil;
...
public class CallThemeBackView extends LinearLayout {
    ...
    private void videoShow(String videoName, final Point point) {
        if (videoName.contains(Environment.getExternalStorageDirectory().getAbsolutePath())) {
            call_theme_back_video.setVideoPath(videoName);
        } else {
